/*Create a class Time with data members Hours, Minutes and Seconds. Add 
appropriate methods in it to accept Time and display Time. By accepting 
values for two Time class objects, find the difference between two Time class 
objects and display it back to user in the form of HH-MM-SS*/
